...
The reviewer's job is not to re-check what CI already checked. Follow `.claude/REVIEW.md`.
Run `bash .claude/bin/harness check --stage commit` first and say nothing about anything it caught.
