...
export async function capture(cfg, { stopReport } = {}) {
  ...
  // here -- `.claude/harness/checks/baseline.mjs` hands over the in-flight results reconstructed into the
...
export const file = (cfg) => path.join(cfg.layout.harness, 'baseline.json');
