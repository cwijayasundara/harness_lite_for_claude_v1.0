...
// actually is — a checkout, or a plugin cache entry. Never a project's own `.claude/harness/`, which only
...
// B1: a template is not an artifact. Read from `.claude/harness/templates/`, never hard-coded — `harness
