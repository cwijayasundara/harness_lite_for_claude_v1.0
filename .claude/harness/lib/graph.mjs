...
// `[graph] exclude` is unioned with this, never replaced by it. `.claude/harness/artifacts/**` holds
// hand-written reproduction scripts and stays indexed.
export const HARNESS_OUTPUT = ['.claude/harness/evals', '.claude/worktrees'];
