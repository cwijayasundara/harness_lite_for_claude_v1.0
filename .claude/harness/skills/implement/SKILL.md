---
name: implement
description: Executes an approved plan in small behavioural slices with focused regression proof and runtime verification. Use whenever code is about to be written for .claude/harness/artifacts/<slug>/plan.md or someone asks to build an approved change.
context: fork
