...
.aidlc/bin/harness check --stage commit   # + scope-drift, budget, arch, baseline
...
.aidlc/bin/harness deliver <slug> --live   # the seven delivery phases, bounded and resumable
...
it. Do not read `.aidlc/state/graph.json` directly; it is a cache format and it will change.
