...
Use `claude auth login` with your Max account and confirm `/status`. Live trials needed
...
Native staging installs no harness and stages no plugin. Its ordinary `CLAUDE.md` describes the
...
private acceptance and commits. These were unattended Claude Code trials, not unrestricted
